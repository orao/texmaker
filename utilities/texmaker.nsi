...
Section "Uninstall"
  ...
  Delete "$INSTDIR\atd.css"
  Delete "$INSTDIR\csshttprequest.js"
  Delete "$INSTDIR\jquery.atd.textarea.js"
  ...
  Delete "$INSTDIR\cs_CZ.aff"
  Delete "$INSTDIR\cs_CZ.dic"
